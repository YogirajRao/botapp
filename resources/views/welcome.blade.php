...
<head>
    ...
    <style>
        body {
            ...
            margin: 0;
            padding: 0;
            background: radial-gradient(#f11338, #0e1010);
        }
